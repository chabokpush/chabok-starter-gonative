...
@interface LEANAppDelegate() <OSSubscriptionObserver, PushClientManagerDelegate>
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    BOOL state = [_manager
                  registerApplication:@"chabok-starter" //based on your environment
    ...
    if (_manager.userId) {
        ...
        [_manager registerUser:@"Chabok-Starter-GoNative"];
    }
